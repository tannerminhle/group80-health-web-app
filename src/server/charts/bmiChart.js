function buildChart(values,userBMI,stats){
  ...
  const dataset = values.map(v=>({bmi:v}))
    ...
    "layer":[
...

      {
        ...
        "encoding":{
          ...
          "x":{"field":"value","type":"quantitative","title":"BMI"},

          "y":{"field":"density","type":"quantitative","title":"Population Density"},
...

      {
        ...
        "data":{"values":[{
          ...
          diffMean:stats.diffMean,
          diffMedian:stats.diffMedian
        }]},
